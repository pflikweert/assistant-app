...
export type BudgetWeekRhythmCardProps = {
...
export function BudgetWeekRhythmCard({
  title = "Deze week",
  periodLabel,
  status,
  remainingAmount,
      ...
      <View style={styles.topRow}>
        <View style={styles.titleWrap}>
          ...
          <Text style={styles.supportLine}>
            {euroFormatter.format(spentAmount)} uitgegeven van{" "}
            {euroFormatter.format(targetAmount)} richtbedrag
          </Text>
        </View>
        ...
        {boundedProgress != null ? (
          <View style={[styles.progressRing, getProgressRingStyle(tone)]}>
            <Text style={styles.progressText}>
              {Math.round(boundedProgress * 100)}%
            </Text>
          </View>
        ) : null}
      </View>
